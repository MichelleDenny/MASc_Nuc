...
V1SensitiveDetector::V1SensitiveDetector(G4String name) : G4VSensitiveDetector(name)
{
    fTotalEnergyDeposited = 0.;
}

V1SensitiveDetector::~V1SensitiveDetector()
{
}

void V1SensitiveDetector::Initialize(G4HCofThisEvent *)
{
    fTotalEnergyDeposited = 0.;
}

G4bool V1SensitiveDetector::ProcessHits(G4Step *aStep, G4TouchableHistory *ROhist)
{
...
void V1SensitiveDetector::EndOfEvent(G4HCofThisEvent *)
{
    G4AnalysisManager *analysisManager = G4AnalysisManager::Instance();
